...
const HELP = `
  clipp — clipp any video. paste. clipp. done.
  ...
  Examples
    ...
    $ clipp https://x.com/user/status/123456
    $ clipp                 (opens the interactive app)
...
if (args.error) {
  console.error(`clipp: ${args.error}\nTry “clipp --help” for usage.`)
  process.exit(1)
}
...
if (outcome.filepath) {
  console.log(`✓ clipped → ${outcome.filepath}`)
}
